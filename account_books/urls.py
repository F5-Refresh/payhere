...
from .views.account_book_detail_views import (
...
urlpatterns = [
    ...
    path(
        'account-books/<int:book_id>/accounts/deleted_list',
    ...
    path(
        'account-books/<int:book_id>/accounts/<int:accounts_id>/togle_delete',
        AccountBookDetailDeleteAPI.as_view(),
        name='book_detail_deleted',
    ),
]
