# Generated by Django 3.2.13 on 2022-07-07 14:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(models.Model, core.util.DeleteFlag),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_flag', models.BooleanField(default=False)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to=settings.AUTH_USER_MODEL, verbose_name='유저')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='account_details', to='account_books.accountcategory', verbose_name='카테고리')),
            ],
            options={
